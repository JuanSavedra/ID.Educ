...
function Navbar() {
  ...
  return (
    <nav className="bg-gray-900 text-white shadow-lg">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="md:hidden flex items-center">
            ...
            >
              ...
              {/* Ícone: mostra 'X' se o menu está aberto, ou 'barras' se está fechado */}
              {isMenuOpen ? (
      ...
      {/* A visibilidade é controlada pela classe 'hidden' ou 'block' baseada no estado */}
